 ...
 */
public class ListadoListaNegraFragment extends Fragment {

    private UltimateRecyclerView mRecycler;
    private ItemListaNegraAdapter mAdapter;
    private ItemListaNegraAdapter mAdapterSavedState;
    private List<ListaNegra> sampleData = null;
    private List<ListaNegra> sampleDataSaveState = null;
    private List<ListaNegra> miListaTemp = null;
    ...
    public static ListadoListaNegraFragment newInstance(String correo, String param2) {

        Log.d(KEY_CICLE, "newInstance");
        ListadoListaNegraFragment fragment = new ListadoListaNegraFragment();
    ...
    public ListadoListaNegraFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.ly_fragments_listanegra, container, false);
        ...
        if(v != null){
            ...
            fabBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(miContexto, BusquedaPersonaActivity.class);
            ...
            if(mAdapter == null){
                ...
                mAdapter = new ItemListaNegraAdapter(new ArrayList<ListaNegra>(),miContexto);
            }
            ...
            if(sampleDataSaveState!= null){
                ...
                mAdapter = new ItemListaNegraAdapter(sampleDataSaveState,miContexto);
            }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null && savedInstanceState.containsKey(KEY_ADAPTER_STATE)){
            ...
            sampleDataSaveState = (List<ListaNegra>) savedInstanceState.getSerializable(KEY_ADAPTER_STATE);
            mAdapter.setSampleData(sampleDataSaveState);
    ...
    /****metodos de carga***/
    private void agregarListaInicio(List<ListaNegra> temp){
    ...
    private void agregarListaFinal(List<ListaNegra> temp){
        for(ListaNegra midato : temp){
    ...
    private boolean verificarDato(ListaNegra midatoB){
        boolean band = false;
        for(ListaNegra midato : mAdapter.getSampleData()){
        ...
        ValueEventListener miValueEventListener =
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        miListaTemp = new ArrayList<ListaNegra>();
                        for (DataSnapshot miSnapshot: dataSnapshot.getChildren()) {
                            ListaNegra miListaNegra = miSnapshot.getValue(ListaNegra.class);
                            miListaTemp.add(miListaNegra);
                            lastKey = miListaNegra.numdoc;
                            Log.i("ListaNegra", miListaNegra.numdoc);
                        }
...
//                        ultimateRecyclerView.setAdapter(simpleRecyclerViewAdapter);
        ...
        */
        ...
        if(modocarga.compareTo("PRI")==0){
            mDatabase.child(GestorDatabase.getInstance(miContexto).obtenerValorUsuario("ruc")).orderByChild("estado")
                    .addListenerForSingleValueEvent(miValueEventListener);
        }else if(modocarga.compareTo("INI")==0){
            mDatabase.child(GestorDatabase.getInstance(miContexto).obtenerValorUsuario("ruc")).orderByChild("estado")
                    .addListenerForSingleValueEvent(miValueEventListener);

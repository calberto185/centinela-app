...
import com.jassgroup.centinela.adapters.ItemVehiculoAdapter;
 ...
 */
public class ListadoVehiculoFragment extends Fragment {

    private UltimateRecyclerView mRecycler;
    private ItemVehiculoAdapter mAdapter;
    private ItemVehiculoAdapter mAdapterSavedState;
    private List<Vehiculo> sampleData = null;
    private List<Vehiculo> sampleDataSaveState = null;
    private List<Vehiculo> miListaTemp = null;
    ...
    public static ListadoVehiculoFragment newInstance(String param1, String param2) {

        Log.d(KEY_CICLE, "newInstance");
        ListadoVehiculoFragment fragment = new ListadoVehiculoFragment();
    ...
    public ListadoVehiculoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_ultimate_recycler_vehiculos, container, false);
        if(v != null){
            /****parte de recyclerview******/
            mRecycler = (UltimateRecyclerView) v.findViewById(R.id.ultimate_recycler_view_vehiculos);
            ...
            if(mAdapter == null){
                ...
                mAdapter = new ItemVehiculoAdapter(new ArrayList<Vehiculo>(),miContexto);
            }
            ...
            if(sampleDataSaveState!= null){
                ...
                mAdapter = new ItemVehiculoAdapter(sampleDataSaveState,miContexto);
            }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null && savedInstanceState.containsKey(KEY_ADAPTER_STATE)){
            ...
            sampleDataSaveState = (List<Vehiculo>) savedInstanceState.getSerializable(KEY_ADAPTER_STATE);
            mAdapter.setSampleData(sampleDataSaveState);
    ...
    /****metodos de carga***/
    private void agregarListaInicio(List<Vehiculo> temp){
    ...
    private void agregarListaFinal(List<Vehiculo> temp){
        for(Vehiculo midato : temp){
    ...
    private boolean verificarDato(Vehiculo midatoB){
        boolean band = false;
        for(Vehiculo midato : mAdapter.getSampleData()){
        ...
        ValueEventListener miValueEventListener =
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        miListaTemp = new ArrayList<Vehiculo>();
                        for (DataSnapshot miSnapshot: dataSnapshot.getChildren()) {
                            Vehiculo miVehiculo = miSnapshot.getValue(Vehiculo.class);
                            miListaTemp.add(miVehiculo);
                            lastKey = miVehiculo.placa;
                            Log.i("Persona", miVehiculo.placa);
                        }
